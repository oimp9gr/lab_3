# Лабораторная работа 3
    ...
    Бонусные задания не обязательны к выполнению. Коэффициент домножения 1.1 на них
    не распространяется.
...
структурой <i>Rectangle</i>, которая содержит целочисленные поля <i>width</i> и <i>height</i>.
...
равнялась 1. Вам также нужно реализовать метод calculateMeanCost структуры Shop,
